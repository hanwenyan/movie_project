...
ratatouille = omdbapi.Movie("Ratatouille","www.youtube.com/watch?v=niD-jahFURU")
unforgiven = omdbapi.Movie("Unforgiven","www.youtube.com/watch?v=khmdFP-PiAg")
tangled = omdbapi.Movie("Tangled","www.youtube.com/watch?v=ip_0CFKTO9E")
matrix = omdbapi.Movie("The Matrix","www.youtube.com/watch?v=hfpbZmQHkWw")
